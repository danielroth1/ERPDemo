...
/**
 * Instantiates a new {@link UserManagementClient} and sets the default values.
 * @param backingStore The backing store to use for the models.
 * @param requestAdapter The request adapter to use to execute the requests.
 */
// @ts-ignore
export function createUserManagementClient(requestAdapter: RequestAdapter, backingStore?: BackingStoreFactory | undefined) {
    ...
    return apiClientProxifier<UserManagementClient>(requestAdapter, pathParameters, UserManagementClientNavigationMetadata, undefined);
}
/**
 * The main entry point of the SDK, exposes the configuration and the fluent API.
 */
export interface UserManagementClient extends BaseRequestBuilder<UserManagementClient> {
    /**
     * The api property
     */
 ...
 */
export const UserManagementClientUriTemplate = "{+baseurl}";
/**
 * Metadata for all the navigation properties in the request builder.
 */
export const UserManagementClientNavigationMetadata: Record<Exclude<keyof UserManagementClient, KeysToExcludeForNavigationMetadata>, NavigationMetadata> = {
    api: {
