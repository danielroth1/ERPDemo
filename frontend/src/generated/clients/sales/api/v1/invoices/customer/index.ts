...
/**
 * Builds and executes requests for operations under /api/v1/Invoices/customer
 */
export interface CustomerRequestBuilder extends BaseRequestBuilder<CustomerRequestBuilder> {
    /**
     * Gets an item from the ApiSdk.api.v1.Invoices.customer.item collection
 ...
 */
export const CustomerRequestBuilderUriTemplate = "{+baseurl}/api/v1/Invoices/customer";
/**
