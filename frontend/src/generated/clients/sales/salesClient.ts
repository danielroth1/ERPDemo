...
/**
 * Instantiates a new {@link SalesClient} and sets the default values.
 * @param backingStore The backing store to use for the models.
 * @param requestAdapter The request adapter to use to execute the requests.
 */
// @ts-ignore
export function createSalesClient(requestAdapter: RequestAdapter, backingStore?: BackingStoreFactory | undefined) {
    ...
    return apiClientProxifier<SalesClient>(requestAdapter, pathParameters, SalesClientNavigationMetadata, undefined);
}
/**
 * The main entry point of the SDK, exposes the configuration and the fluent API.
 */
export interface SalesClient extends BaseRequestBuilder<SalesClient> {
    /**
     * The api property
     */
 ...
 */
export const SalesClientUriTemplate = "{+baseurl}";
/**
 * Metadata for all the navigation properties in the request builder.
 */
export const SalesClientNavigationMetadata: Record<Exclude<keyof SalesClient, KeysToExcludeForNavigationMetadata>, NavigationMetadata> = {
    api: {
