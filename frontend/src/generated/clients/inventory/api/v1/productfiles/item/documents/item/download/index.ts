...
/**
 * Builds and executes requests for operations under /api/v1/productfiles/{id}/documents/{docId}/download
 */
 ...
 */
export const DownloadRequestBuilderUriTemplate = "{+baseurl}/api/v1/productfiles/{id}/documents/{docId}/download";
/**
