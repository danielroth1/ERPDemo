...
/**
 * Instantiates a new {@link FinancialClient} and sets the default values.
 * @param backingStore The backing store to use for the models.
 * @param requestAdapter The request adapter to use to execute the requests.
 */
// @ts-ignore
export function createFinancialClient(requestAdapter: RequestAdapter, backingStore?: BackingStoreFactory | undefined) {
    ...
    return apiClientProxifier<FinancialClient>(requestAdapter, pathParameters, FinancialClientNavigationMetadata, undefined);
}
/**
 * The main entry point of the SDK, exposes the configuration and the fluent API.
 */
export interface FinancialClient extends BaseRequestBuilder<FinancialClient> {
    /**
     * The api property
     */
 ...
 */
export const FinancialClientUriTemplate = "{+baseurl}";
/**
 * Metadata for all the navigation properties in the request builder.
 */
export const FinancialClientNavigationMetadata: Record<Exclude<keyof FinancialClient, KeysToExcludeForNavigationMetadata>, NavigationMetadata> = {
    api: {
