...
/**
 * Instantiates a new {@link OrchestrationClient} and sets the default values.
 * @param backingStore The backing store to use for the models.
 * @param requestAdapter The request adapter to use to execute the requests.
 */
// @ts-ignore
export function createOrchestrationClient(requestAdapter: RequestAdapter, backingStore?: BackingStoreFactory | undefined) {
    ...
    return apiClientProxifier<OrchestrationClient>(requestAdapter, pathParameters, OrchestrationClientNavigationMetadata, undefined);
}
/**
 * The main entry point of the SDK, exposes the configuration and the fluent API.
 */
export interface OrchestrationClient extends BaseRequestBuilder<OrchestrationClient> {
    /**
     * The api property
     */
 ...
 */
export const OrchestrationClientUriTemplate = "{+baseurl}";
/**
 * Metadata for all the navigation properties in the request builder.
 */
export const OrchestrationClientNavigationMetadata: Record<Exclude<keyof OrchestrationClient, KeysToExcludeForNavigationMetadata>, NavigationMetadata> = {
    api: {
