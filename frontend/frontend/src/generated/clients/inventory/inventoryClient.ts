...
/**
 * Instantiates a new {@link InventoryClient} and sets the default values.
 * @param backingStore The backing store to use for the models.
 * @param requestAdapter The request adapter to use to execute the requests.
 */
// @ts-ignore
export function createInventoryClient(requestAdapter: RequestAdapter, backingStore?: BackingStoreFactory | undefined) {
    ...
    return apiClientProxifier<InventoryClient>(requestAdapter, pathParameters, InventoryClientNavigationMetadata, undefined);
}
/**
 * The main entry point of the SDK, exposes the configuration and the fluent API.
 */
export interface InventoryClient extends BaseRequestBuilder<InventoryClient> {
    /**
     * The api property
     */
 ...
 */
export const InventoryClientUriTemplate = "{+baseurl}";
/**
 * Metadata for all the navigation properties in the request builder.
 */
export const InventoryClientNavigationMetadata: Record<Exclude<keyof InventoryClient, KeysToExcludeForNavigationMetadata>, NavigationMetadata> = {
    api: {
