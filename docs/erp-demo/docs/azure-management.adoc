...
Relevant scripts for the bash examples on this page: {repo-base}/scripts/aks-stop.sh#L1[scripts/aks-stop.sh#L1] and {repo-base}/scripts/aks-start.sh#L1[scripts/aks-start.sh#L1]
...
If none of those changed, {repo-base}/scripts/aks-start.sh#L1[scripts/aks-start.sh#L1] is enough.
