...
var postgresConnectionString = builder.Configuration.GetConnectionString("erp-users")
...
// Apply schema on startup (all environments including K8s)
...
try
{
    ...
    Console.WriteLine("\n" + new string('=', 80));
    Console.WriteLine("USER MANAGEMENT SERVICE - Enterprise Resource Planning System");
    Console.WriteLine(new string('=', 80));
    Console.WriteLine($"Service Name:       User Management");
    ...
    Log.Information("User Management Service started successfully");
    app.Run();
}
catch (Exception ex)
{
